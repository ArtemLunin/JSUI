...
/* harmony import */ var _servises_requests__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./servises/requests */ "./src/js/lib/servises/requests.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.index = function () {
  const parent = this[0].parentNode; // делаем массив из HTML коллекции

  const childs = [...parent.children];

  const findMiIndex = item => {
    return item == this[0];
  };

  return childs.findIndex(findMiIndex);
};

_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  let numberOfItems = 0;
  let counter = 0; // создаем копию объекта, чтобы избежать багов
  ...
  this.length = numberOfItems; //  удалим из объекта предыдущие свойста, которые уже не используются
...
/***/ "./src/js/lib/servises/requests.js":
/*!*****************************************!*\
  !*** ./src/js/lib/servises/requests.js ***!
  \*****************************************/
/*! no exports provided */
